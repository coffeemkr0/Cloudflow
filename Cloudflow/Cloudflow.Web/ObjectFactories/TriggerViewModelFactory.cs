...
{
    [ExportExtension("A530569D-546E-44CD-A957-39E330E12B9F", typeof(TriggerViewModelFactory))]
    public class TriggerViewModelFactory : ObjectFactory
    {
        [ImportingConstructor]
        public TriggerViewModelFactory([Import("factoryData")]string factoryData) : base(factoryData)
        {
